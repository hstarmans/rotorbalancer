...
The phase difference between these must be 180 degrees for the measurement to be accurate. The location of the minimum will be the location of the balance weight. The phase angle was relatively constant in the range 97-144 Hz but the force did not follow a square law as expected from the centrepetal force. It is assumed this is due to nonlinearity in the materials and the imperfect setup. The location of putty and the mass will also be dependent upon the setup as it can introduce inaccuracies.<br>
